<script>
    ...
    //ACADEMIC RELATED**************************
    var arrayMath = ['Do Aleks', 'Practice Math Facts', 'Do Mental Math', 'Do Kumon Multiplication','Do Kumon Division', 'Do Flash Cards', 'Do basic Algebra', 'Do basic Geometry', 'Do Fractions and Decimals'];
    ...
    var arrayMediaPlay = ['Play Minecraft', 'Play Beach Buggy Racing', 'Play Toca Hair Salon','play amazon game'];
